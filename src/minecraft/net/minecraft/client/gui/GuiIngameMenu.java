...
import senseiclient.gui.MainMenu;
import senseiclient.gui.clickgui.FeatherClickGUI;
...
public class GuiIngameMenu extends GuiScreen
{
    ...
    public void initGui()
    {
        ...
        this.buttonList.add(new GuiButton(69, this.width /2 -100,this.height /2 + 40, "ModMenu"));
